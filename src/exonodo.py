...
class exonodo:
    ...
    def register(self):
        ...
        'press y to confirm'
        if input(txt_tmp) == 'y':
            zenodo_reg.zenodo_main(data=self.data, token=self.token, path_root=self.path_root)
        else:
...
xx = exonodo(token = 'Mitwo0cwfer47Lvx51CTawELNJt9OYknMfP5WOvmNvJcYspgo9dGYDQiEFlL',
